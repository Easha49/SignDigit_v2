        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userFullname)) {
                    ...
                    Toast.makeText(SignUp.this,Integer.toString(all_ok) , Toast.LENGTH_LONG).show();
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(SignUp.this,"LOL LOL  ", Toast.LENGTH_LONG).show();
                        all_ok ++ ;
                    } else {
                        editTextUsername.setError(null);
                        Toast.makeText(SignUp.this,"No user matched " + Integer.toString(all_ok), Toast.LENGTH_LONG).show();
