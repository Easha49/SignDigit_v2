            ...
            public void onClick(View view) {
                ...
                referenceProfile.child("ratingApp").setValue(NewRating).addOnSuccessListener(new OnSuccessListener<Void> () {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(Rating.this,"Thank you for rating our app! ",Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener () {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Rating.this,e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                }) ;
                // for ever click //
                ...
                query.addListenerForSingleValueEvent(new ValueEventListener () {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(Rating.this,"Something Wrong .\n Try again ! ",Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
